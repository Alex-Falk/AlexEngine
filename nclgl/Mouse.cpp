...
{
	absolutePosition.x = static_cast<float>(x);
	absolutePosition.y = static_cast<float>(y);
}
...
{
	absolutePositionBounds.x = static_cast<float>(maxX);
	absolutePositionBounds.y = static_cast<float>(maxY);
}
