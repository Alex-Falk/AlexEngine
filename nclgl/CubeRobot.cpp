...
void CubeRobot::Update(float msec) {
	...
	leftArm->SetTransform(leftArm->GetTransform() * Maths::Matrix4::CreateRotationMatrix(-msec / 10.0f,Vector3(1,0,0)));
	rightArm->SetTransform(rightArm->GetTransform() * Maths::Matrix4::CreateRotationMatrix(msec / 10.0f,Vector3(1,0,0)));
