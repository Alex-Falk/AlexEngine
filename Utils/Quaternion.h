...
namespace Maths
{
	...
	public:
		...
		void GenerateW();
		//builds 4th component when loading in shortened, 3 component quaternions - great for network compression ;)
		...
		//Rotates point around quaternion (Quaternion * Vector3 was taken already)

		static Quaternion LookAt(const Vector3& from, const Vector3& to, const Vector3& up = Vector3(0, 1, 0));
		static Quaternion GetRotation(const Vector3& from_dir, const Vector3& to_dir,
