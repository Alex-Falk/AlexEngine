...
Maths::Matrix3::Matrix3(float e[9]) :
...
Maths::Matrix3::Matrix3(const Vector3& c1, const Vector3& c2, const Vector3& c3)
{
...
Maths::Matrix3::~Matrix3(void)
{
}

//Default States
void Maths::Matrix3::ToZero()
{
...
Maths::Matrix3 Maths::Matrix3::OuterProduct(const Vector3& a, const Vector3& b)
{
	Matrix3 m;
